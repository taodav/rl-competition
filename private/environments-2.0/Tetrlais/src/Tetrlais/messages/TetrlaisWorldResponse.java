...
public class TetrlaisWorldResponse extends AbstractResponse {
	private int world_width =0;
	private int world_height =0;
	
	public TetrlaisWorldResponse(int width, int height){
		this.world_width = width;
		this.world_height = height;
	}
	
	public TetrlaisWorldResponse(String responseMessage)throws NotAnRLVizMessageException{
