...
//
    ...
    public State_key env_get_state() {
        if (allowSaveLoadState) {
            savedStates.add(new PolyProblemTypeAState(theState));
    ...
    public void env_set_state(State_key k) {
        if (allowSaveLoadState) {
            ...
            PolyProblemTypeAState oldState = savedStates.get(k.intArray[0]);
            this.theState = new PolyProblemTypeAState(oldState);
            return;
        }
