...
import SamplePolyathlon.ProblemTypeF.Messages.CGWMapResponse;
import SamplePolyathlon.ProblemTypeF.Messages.CGWPositionResponse;
...
//	protected  Point2D theState=new Point2D.Double(0,0);
    ...
    protected double catchPunishment = -100.0;
    ...
    public String env_init() {
        ...
        return taskSpecVersion + ":e:4_[f,f,f,f]_[" + getWorldRect().getMinX() + "," + getWorldRect().getMaxX() + "]_[" + getWorldRect().getMinY() + "," + getWorldRect().getMaxY() + "]_[" + getWorldRect().getMinX() + "," + getWorldRect().getMaxX() + "]_[" + getWorldRect().getMinY() + "," + getWorldRect().getMaxY() + "]:1_[i]_[0,3]:[-1,1]";
    }
