...
public class TetrisBlock {
	...
	public static TetrisBlock makeSquare(){
		TetrisBlock newPiece = new TetrisBlock();
	...
	public static TetrisBlock makeTri(){
		TetrisBlock newPiece = new TetrisBlock();
		...
		public static TetrisBlock makeLine(){
		TetrisBlock newPiece = new TetrisBlock();
		...
		public static TetrisBlock makeSShape(){
			TetrisBlock newPiece = new TetrisBlock();
		...
		public static TetrisBlock makeZShape(){
			TetrisBlock newPiece = new TetrisBlock();
		...
		public static TetrisBlock makeLShape(){
			TetrisBlock newPiece = new TetrisBlock();
		...
		public static TetrisBlock makeJShape(){
			TetrisBlock newPiece = new TetrisBlock();
