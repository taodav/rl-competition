...
public class ConstantSet {
    ...
    protected double targetXPosition;
    protected double targetYPosition;
    protected double targetReward;
    ...
    public ConstantSet(){
        ...
        // Fluid properties 
        // resistance offered by the fluid to the octopus
        this.frictionTangential=0.4d;
        this.frictionPerpendicular=1.0d;
        
        // buoyancy = tendency to float towards surface
        // should cancel gravity in water     
        this.pressure=10.0d;
        this.gravity=0.01d;
        ...
        // repulsion of food pellets from other particles
         ...
         *   Parametrization #1
         * ============================= */
        // IMPORTANT NOTE:remember to change the parametrization in 
        // ArmSpec.java as well
        
        /*this.buoyancy=0.08d;
        this.surfaceLevel = 3.1;
        this.muscleActive = 0.09;
        // target is on the left middle-bottom relative to the base
        this.targetXPosition= -2.1;
        this.targetYPosition= -5.2;
        */
        /* ============================
         *   Parametrization #2
         * ============================= */
...
//        this.buoyancy = 0.01d;
//        this.surfaceLevel = 0;
//        this.muscleActive = 0.24;
//        // target is on the far right
//        this.targetXPosition= 7.8;
...
>>>>>>> .r677
        ...
        this.buoyancy=-1.0d;   
        this.surfaceLevel = 3.3;
        this.muscleActive = 0.17;
        // target is directly above the base 
        this.targetXPosition= -0.4;
        this.targetYPosition= 3.2;
        
        
        
        
        
        this.targetReward=20.0d;
    }
    /**
   <frictionTangential>0.4</frictionTangential>
    ...
    public void setTargetXPosition( double value ) {
        this.targetXPosition = value;
    }
    
    public void setTargetYPosition( double value ) {
        this.targetYPosition = value;
    }
    
    public void setTargetReward( double value ) {
        this.targetReward = value;
    }
