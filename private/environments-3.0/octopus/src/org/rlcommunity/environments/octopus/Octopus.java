...
import org.rlcommunity.environment.octopus.protocol.*;



import org.rlcommunity.environment.octopus.config.ChoiceSpec;
import org.rlcommunity.environment.octopus.config.EnvSpec;
import org.rlcommunity.environment.octopus.config.FoodSpec;
import org.rlcommunity.environment.octopus.config.FoodTaskDef;
import org.rlcommunity.environment.octopus.config.NewConfig;
...
import org.rlcommunity.environment.octopus.components.Arm;
import org.rlcommunity.environment.octopus.components.ArmBase;
import org.rlcommunity.environment.octopus.components.Compartment;
import org.rlcommunity.environment.octopus.components.Constants;
import org.rlcommunity.environment.octopus.components.EnvironmentSimulator;
import org.rlcommunity.environment.octopus.components.Food;
import org.rlcommunity.environment.octopus.components.Mouth;
import org.rlcommunity.environment.octopus.components.Target;
import org.rlcommunity.environment.octopus.visualizer.OctopusVisualizer;
import java.util.*;
import org.rlcommunity.environment.octopus.messages.OctopusStateResponse;
import org.rlcommunity.environment.octopus.messages.OctopusCoreDataResponse;
...
public class Octopus extends EnvironmentBase implements HasAVisualizerInterface,HasImageInterface {
    ...
    boolean useDiscreteActions = false;
    private Arm arm;
...
//        }
        ...
        if (useDiscreteActions) {
			...
			//Add 2 more for the base of the arm.
            theTaskSpecObject.addContinuousAction((new DoubleRange(minAction, maxAction, ts.getNumActionVariables()+2)));
        }
