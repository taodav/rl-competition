 ...
 * @author btanner
 */
public abstract class AbstractPolyProblemTypeG extends EnvironmentBase implements HasAVisualizerInterface {
    ...
    public AbstractPolyProblemTypeG() {
        this(getDefaultParameters());
    }

    public AbstractPolyProblemTypeG(ParameterHolder p) {
        super();
        if (p != null) {
            if (!p.isNull()) {
