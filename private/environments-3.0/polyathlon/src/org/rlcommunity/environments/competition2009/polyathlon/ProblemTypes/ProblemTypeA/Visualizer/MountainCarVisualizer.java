...
package org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeA.Visualizer;
...
import org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeA.Messages.MCGoalRequest;
import org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeA.Messages.MCGoalResponse;
import org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeA.Messages.MCHeightRequest;
import org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeA.Messages.MCHeightResponse;
import org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeA.Messages.MCStateRequest;
    ...
    public Vector<Double> queryAgentValues(Vector<Observation> theQueryObs) {
        ...
        if (needsUpdate) {
            try {
                ...
                Logger.getLogger(MountainCarVisualizer.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
