...
public class PolyProblemTypeFMapComponent implements VizComponent {
	AbstractPolyProblemTypeFVisualizer CGWViz;
	public PolyProblemTypeFMapComponent(AbstractPolyProblemTypeFVisualizer CGWViz){
		this.CGWViz=CGWViz;
	}
