...
public class PolyPMDP64 extends AbstractMDPPolyProblemTypeB implements Unloadable{
Random myRand=new Random();
    ...
    protected Observation MDPSpecificMakeObservation() {
        ...
        currentObs.doubleArray[1]=myRand.nextDouble();
    ...
    protected void addAllRegions() {
		...
		addRewardRegion(new Rectangle2D.Double(50.0d,50.0d,10.0d,100.0d),-50.0d);
		addRewardRegion(new Rectangle2D.Double(50.0d,50.0d,100.0d,10.0d),-50.0d);
		addRewardRegion(new Rectangle2D.Double(150.0d,50.0d,10.0d,100.0d),-50.0d);
    }
