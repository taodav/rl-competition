...
import org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeB.Messages.CGWMapRequest;
import org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeB.Messages.CGWMapResponse;
import org.rlcommunity.environments.competition2009.polyathlon.ProblemTypes.ProblemTypeB.Messages.CGWPositionRequest;
...
public class AbstractPolyProblemTypeBVisualizer extends AbstractVisualizer implements ValueFunctionDataProvider, AgentOnValueFunctionDataProvider, GlueStateProvider {
    ...
    public AbstractPolyProblemTypeBVisualizer(TinyGlue glueState, DynamicControlTarget theControlTarget) {
        super();
...
//        VizComponent theValueFunction = new ValueFunctionVizComponent(this,theControlTarget);
        ...
        VizComponent theMapComponent = new PolyProblemTypeBMapComponent(this);
...
//        super.addVizComponentAtPositionWithSize(theValueFunction, 0, 0, 1.0, 1.0);
      ...
      int currentTimeStep = theGlueState.getTotalSteps();
        ...
        if (needsUpdate) {
            try {
                ...
                Logger.getLogger(AbstractPolyProblemTypeBVisualizer.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public double getCurrentStateInDimension(int whichDimension) {
        ...
        if(whichDimension==0)return thisResponse.getX();
        else
